...
#define CM4_DAP_OK_VALUE 0x24770011
#define CM4_DAP_REG1_OFFSET 0x0
#define CM4_DAP_REG2_OFFSET 0x4
#define CM4_DAP_REG3_OFFSET 0xc
#define CM4_DAP_STATUS_OFFSET 0xfc
...
/* Efuse */
#define REG_AON_APB_EB					(AON_APB_BASE_ADDR + 0x24)
#define BIT_AON_APB_EFUSE_EB		 	 	 BIT(11)

#define REG_AON_APB_CLK_CTRL4				(AON_APB_BASE_ADDR + 0x50)
#define BIT_AON_APB_CGM_EFUSE_EN	 	 	 BIT(18)

#define REG_AON_APB_CGM_EN				(AON_APB_BASE_ADDR + 0x32C)
#define BIT_AON_APB_EFUSE_SELE_FRC_EB		 BIT(22)

#define WCN_XPE_EFUSE_DDR					 0x40859030

#define REG_AON_AHB_EFUSE_BASE			 0x40858000
#define REG_AON_AHB_EFUSE_SEC_EN			(REG_AON_AHB_EFUSE_BASE + 0x40)
#define BIT_AON_AHB_EFUSE_SEC_EN			 BIT(0)
