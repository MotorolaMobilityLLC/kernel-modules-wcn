...
#define WLAN_CIPHER_SUITE_DPP		0x000FAC02
/* AKM suite */
...
#define SPRDWL_SCAN_RESULT_MAX_IE_LEN	1500
/* before feature is reported by mac ,now drv defined itself because mac not report it */
#define SPRDWL_MAX_SCHED_PLANS		1
