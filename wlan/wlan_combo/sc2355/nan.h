...
struct nan_publish_config_params {
	u16 ttl;
	u16 period;
	u32 reserved:1;
	u32 publish_type:2;
...
struct nan_publish_req {
	struct nan_msg_header header;
	struct nan_publish_config_params pub_params;
	/* TLVs:
	 *
...
struct nan_subscribe_config_parames {
	u16 ttl;
	u16 period;
...
struct nan_subscribe_req {
	struct nan_msg_header header;
	struct nan_subscribe_config_parames sub_params;
	/* TLVs:
	 *
	 * Required: Service Name
...
struct nan_followup_config_params {
...
struct nan_followup_req {
	struct nan_msg_header header;
	struct nan_followup_config_params followup_params;
	/* TLVs:
	 *
