...
#define SPRD_VENDOR_EVENT_ASSERT_INDEX	100
#define SPRD_EVENT_ASSERT		33
#define SPRD_ATTR_ASSERT		19
...
enum vendor_attr_chan_info {
	ATTR_CHAN_INFO_INVALID = 0,
	ATTR_CHAN_INFO_PRIMARY_FREQ = 1,
	ATTR_CHAN_INFO_SEG0_FREQ = 2,
	ATTR_CHAN_INFO_SEG1_FREQ = 3,
	ATTR_CHAN_INFO_BANDWIDTH = 4,
	ATTR_CHAN_INFO_IFACE_MODE_MASK = 5,

	/* keep last */
	ATTR_CHAN_INFO_AFTER_LAST,
	ATTR_CHAN_INFO_MAX =
	ATTR_CHAN_INFO_AFTER_LAST - 1,
};

enum vendor_attr_usable_channels {
	ATTR_USABLE_CHANNELS_INVALID = 0,
	ATTR_USABLE_CHANNELS_BAND_MASK = 1,
	ATTR_USABLE_CHANNELS_IFACE_MODE_MASK = 2,
	ATTR_USABLE_CHANNELS_FILTER_MASK = 3,
	ATTR_USABLE_CHANNELS_CHAN_INFO = 4,

	/* keep last */
	ATTR_USABLE_CHANNELS_AFTER_LAST,
	ATTR_USABLE_CHANNELS_MAX =
	ATTR_USABLE_CHANNELS_AFTER_LAST - 1,
};

static const struct
nla_policy vendor_usable_channels_policy[ATTR_USABLE_CHANNELS_MAX + 1] = {
	[ATTR_USABLE_CHANNELS_BAND_MASK] = { .type = NLA_U32 },
	[ATTR_USABLE_CHANNELS_IFACE_MODE_MASK] = { .type = NLA_U32 },
	[ATTR_USABLE_CHANNELS_FILTER_MASK] = { .type = NLA_U32 },
};
